                        ...
                        <div class="row mb-minus-50">
                                ...
                                <div class="footer-2__widget footer-2__widget-item-1">
                                    <div class="footer-2__logo mb-35">
                                        <a href="index.php">
                                            ...
                                            <h5 style="color: #fff;"><b>Ultrafine Precision Engineering</b></h5>
                                        </a>
                                    </div>

                                    <div class="footer-2__content mb-25 mb-xs-20">
                                        <p class="mb-0">Experience unparalleled accuracy with our cutting-edge engineering solutions. We specialize in delivering seamless and efficient results, ensuring precision at every step. With the freedom to innovate, we craft solutions that stand the test of time.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="footer-2__widget footer-2__widget-item-3">
                                    ...
                                    <div class="footer-2__link">
                                        <ul>
                                            <li><a href="service.php">Machinery Services</a></li>
                                            <li><a href="service.php">Govt ITI Machine Services</a></li>
                                            <li><a href="service.php">General Services</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-4">
                                <div class="footer-2__social justify-content-center">
                                    ...
                                    <a href="https://wa.me/+919600401004" style="color: #fff;">
                            ...
                            <div class="col-xl-4 mt-4">
                                <div class="footer-2__copyright text-xl-start text-center">
                                    <p class="mb-0">Design and Development By <a href="https://trymywebsites.com/">Trymywebsites</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
